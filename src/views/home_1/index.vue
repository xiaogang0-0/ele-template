  ...
  <div class="divBody">
    <div class="login-container ">
      ...
      <div class="content">
        ...
        <div class="wrap">
          <div class="wrap-bg">
            <img v-show="bgImgUrlArr" :src="bgImgUrlArr" alt="" class="bgImgUrl">
          </div>
          <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
            ...
            <p
              class="pd60"
              style="text-align: center;margin: -45px 0 12px;cursor: pointer; color:#1890ff;"
...
export default {
  ...
  methods: {
    ...
    handeGetBgImgUrlArr() {
      ...
      // 18000 PC平台端登录页主图
      const param = 16000
      Api.getBgImgUrlArr(param).then(res => {
          ...
          Api.loginInit(param).then(res => {
            ...
            if (res.code == 200) {
              ...
              if (res.data.customerStatus == 0) {
                ...
                localStorage.setItem('YXKJ_registerInfor', JSON.stringify(itemData))
                // 跳转完善页面
                this.$router.push({
              ...
              if (res.data.userType == 1) {
                // 后台登录
                localStorage.setItem('YXKJ_menuList', JSON.stringify(menuList.home))
              } else {
                // 客户端
                localStorage.setItem('YXKJ_menuList', JSON.stringify(menuList.login))
              }
