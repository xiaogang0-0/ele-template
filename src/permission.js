...
// 没有重定向白名单
const whiteList = ['/login', '/demo', '/home', '/forgetPassword', '/changePassword', '/register', '/perfectInformation', '/auth-redirect', '/404', '/operationGuide', '/service']
    ...
    if (to.path === '/login' || to.path === '/home') {
      ...
      if (hasRoles) {
        ...
        try {
          ...
          const userType = JSON.parse(localStorage.getItem('YXKJ_userInfo')).userType
          // console.log(userType,'本地的目录userType')

          // 后台获取回來的路由
          const menuList = JSON.parse(localStorage.getItem('YXKJ_menuList'))
